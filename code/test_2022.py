...
parser.add_argument('--output_folder', type=str, default='output_moni_2022', help="output image path")
parser.add_argument('--checkpoint', type=str, default='output_moni_2022/outputs/unit_noise2clear-bn/checkpoints/gen_00050000.pt',
...
# motion_path = '/home/user/data4/chongxin/LIR-for-Unsupervised-IR_DataLoad/dataset/moni_se_2022/paired/train_motion.mat'
motion_path='/home/user/NewSpace/xh/LIR-for-Unsupervised-IR_Mat2/dataset/paired_v2/train_motion.mat'
motion_mat = sio.loadmat(motion_path)
motion = motion_mat['train_motion']
motion = np.float32(motion)
motion = motion[571:1140,:,:]
num = len(motion)
...
for i in range(num):
    ...
    out[i,:,:] = final[:,:]
out = np.float64(out)
sio.savemat(os.path.join(opts.output_folder, 'corrected_trainall2.mat'),{'corrected':out})