...
parser.add_argument('--output_path', type=str, default='/home/user/data4/chongxin/LIR-for-Unsupervised-IR_Mat2/output_moni_2022/', help="outputs path")
...
def main():
    ...
    output_directory = os.path.join(opts.output_path + "/outputs_ablation", model_name)
    checkpoint_directory, image_directory = prepare_sub_folder(output_directory)
    shutil.copy(opts.config, os.path.join(output_directory, 'config.yaml')) # copy config file to output folder

    loss_path = opts.output_path + "/loss_ablation/"
